            ...
            <div className="space-y-6 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 px-10 py-5 bg-whatsapp hover:bg-whatsapp-dark text-white text-lg font-semibold rounded-lg shadow-whatsapp hover:shadow-2xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-whatsapp focus:ring-offset-2 active:scale-95"
                >
